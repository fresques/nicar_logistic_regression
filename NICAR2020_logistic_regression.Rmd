...
```
But instead of p(y) = A + Bx, we now have: p(y) = exp(A + Bx) / (exp(A + Bx) + 1)
...
The coefficient for mphpct is 0.09205, which tells us (just like in linear regression) that a 1 percentage point increase in mphpct means an increase in the log odds of getting a ticket of about 0.09:

log odds at mphpct + 1 = log odds of getting a ticket at mphpct + 0.09
